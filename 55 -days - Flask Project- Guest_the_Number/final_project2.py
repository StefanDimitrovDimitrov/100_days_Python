...
dict_result = {
    'win': f'<h1 style="color:{random.choice(list_color)}">You found me!</h1><img src={won_url} width=500>',
    'low': f'<h1 style="color:{random.choice(list_color)}">Too low. Try again!</h1><img src={random.choice(list_gift_low)} width=500>',
    'high': f'<h1 style="color:{random.choice(list_color)}">Too high. Try again!</h1><img src={random.choice(list_gift_high)} width=500>',
}
#
